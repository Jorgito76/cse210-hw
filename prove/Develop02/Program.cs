...
class Journal
{
    ...
    public void WriteEntry()
    {
        ...
        Entry newEntry = new Entry(_prompt, _response, DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
    ...
    public bool ListSavedJournals()
    {
        ...
        foreach (string journal in _savedJournals)
        {
    ...
    public void RefreshSavedJournals()
    {
        try
        {
            ...
            {
                _savedJournals.Add(Path.GetFileName(file));
            }
        }
        catch (Exception ex)
        {
